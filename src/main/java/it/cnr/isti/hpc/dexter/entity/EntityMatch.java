...
public class EntityMatch implements Comparable<EntityMatch> {
	...
	private static final Logger LOGGER = Logger.getLogger(EntityMatch.class);
	...
	private EntityMatch(String id, double score) {
		super();
	...
	public EntityMatch(Entity e, double score, SpotMatch spot) {
		...
		this.score = score;
		this.spot = spot;
		LOGGER.debug("EntityMatch: " + e.getId() + " Score: " + score);

	}

	public EntityMatch(String id, double score, SpotMatch spot) {
		this(id, score);
		this.spot = spot;
	}
