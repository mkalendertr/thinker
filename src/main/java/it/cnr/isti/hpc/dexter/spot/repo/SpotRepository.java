...
/**
 * SpotRepository allows to retrieve metadata referring to a {@link Spot spot},
 * i.e., a piece of text referring to one or more <i>entities</i>.
 * 
 * @see Spot
...
public interface SpotRepository {
	 ...
	 * given text is associated to one or more entities. Otherwise, it will
	 * return null.
	 * 
	 * @param spot
	 ...
	 * 
	 */
	public Spot getSpot(String spot, String inputText, String wholeText,
			Shingle shingle);
