 ...
 * 
 */
public class EntityEmbeddingSoftmax {
	private static final Logger LOGGER = Logger
			.getLogger(EntityEmbeddingSoftmax.class);
	...
	private static String modelFile = "embedding_network_autoencoder_test.model";
	...
	public static void main(final String args[]) {
		EntityEmbeddingSoftmax ee = new EntityEmbeddingSoftmax();
		ee.train();
	...
	public BasicNetwork train() {
		...
		network.addLayer(new BasicLayer(null, true, inputSize * 2));
		network.addLayer(new BasicLayer(new ActivationTANH(), true, 300));
		network.addLayer(new BasicLayer(new ActivationTANH(), true, 150));
