...
Besides source codes of the project, we publish taxonomy represented for entity discovery, pre-trained entity vectors and experiment data sets:
  ...
  - [Vikipedi_Entity_Vectors](https://drive.google.com/open?id=1tpQM1mpFbcghZCVpJRW7NZqxyNYLSPRn): The archive contains a json file that contains the Metadata Vectors: Entity vectors trained on category, type and infobox information of Vikipedi articles.
